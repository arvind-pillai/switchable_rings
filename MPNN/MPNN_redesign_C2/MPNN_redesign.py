...
directory = "/home/apillai1/final_production_run/combined/"  #<-- Folder containing worms outputs selected
...
for filename in os.listdir(directory):
  ...
  #Fixes these residues to try and preserve hinge conformational switch (shown in Fig E1)
